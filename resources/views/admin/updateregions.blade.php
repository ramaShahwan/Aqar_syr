...
<label for="" class="form-label" style="color: blue; font-size: 20px; text-align: center;">تعديل المنطقة</label>
 ...
 @csrf
    ...
    @enderror
     ...
     <div class="mb-3" style="margin-left: 10px; margin-right: 10px;">
        ...
        <select class="form-select @error('city_id') is-invalid @enderror" name="city_id" id="city_id" aria-label="Default select example" style="background-color: white; color:black; text-align: end; width: 450px;
    height: 30px;
...
@enderror
	...
	<button type="submit" class="btn btn-sm btn-primary" style=" background-color:#406a98;margin-left: 20%; margin-bottom: 20px; font-size: 20px;">تعديل المنطقة</button>
