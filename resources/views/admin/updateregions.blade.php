 ...
 @csrf
	...
	<div class="mb-3" style="margin-left: 10px; margin-right: 10px;">
     ...
     <div class="mb-3" style="margin-left: 10px; margin-right: 10px;">
        ...
        <select class="form-select" name="city_id" id="city_id" aria-label="Default select example" style="background-color: white; color:black; text-align: end; width: 450px;
    height: 30px;
