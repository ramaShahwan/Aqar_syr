...
<div class="container-xxl position-relative bg-white d-flex p-0">
   ...
   <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4" style="width:1000px;">
                 ...
                 <a class="btn btn-sm btn-primary" href="{{url('adduser')}}" style="width: 100px;font-size: 20px;    background-color:#406a98">إضافة مالك</a>

              </li>
                    <!-- <a href="" class="btn btn-sm btn-primary" style="width: 150px;height: 40px;font-size: 20px;">اضافة مدينة </a> -->
                        <h6 class="mb-0" style="font-size: 30px;">المستخدمين</h6>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col" style="text-align: center;font-size: 20px; width: 300px;">الصلاحية</th>
                            ...
                            <tbody>
                            @foreach($users as $calll)


                                <tr>

                                    <td style="text-align: center;font-size: 20px;"><a class="btn btn-sm btn-danger"onclick="return confirm('هل تريد الحذف')" href="{{url('user/destroy',$calll->id)}}"  style="width: 90px;">حذف</a>
                                    <a class="btn btn-sm btn-primary" href="{{url('user/edit', $calll->id)}}" style="width: 90px;    background-color:#28a745">تعديل</a></td>
                                    <td style="text-align: center;font-size: 20px;">{{$calll->role}}</td>
