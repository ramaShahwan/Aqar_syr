...
@endif
<label for="" class="form-label" style="color: blue; font-size: 20px; text-align: center;"> مالك جديد</label>
<form action="{{url('owner/store')}}" method="POST" enctype="multipart/form-data">
 @csrf
    ...
    <div class="mb-3" style="margin-left: 10px; margin-right: 10px; width: 490px;">
        ...
        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"  required autocomplete="phone" style="background-color: white; color:black; text-align: end;"  >
                             @error('phone')
    ...
    <div class="mb-3" style="margin-left: 10px; margin-right: 10px;">
        ...
        <input type="text" name="description"  class="form-control @error('description') is-invalid @enderror" style="background-color: white; color:black; text-align: end; width: 460px;"  >
        @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
	...
	<button type="submit" class="btn btn-sm btn-primary" style=" background-color:#406a98;margin-left: 20%; margin-bottom: 20px; font-size: 20px;width: 100px;">إضافة مالك</button>
