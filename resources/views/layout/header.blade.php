...
<header class="header">
    ...
    <li ><a href="{{ route('dashboardd') }}" class="gg">لوحة التحكم</a></li>
@endif

                            @if(auth()->check())
    <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="gg">تسجيل خروج</a></li>
    <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
        @csrf
    </form>
@else
    <li><a href="{{ route('login') }}" class="gg">تسجيل دخول</a></li>
@endif
                            <li><a href="{{route('contact')}}" class="gg">تواصل</a></li>

                            <li><a href="{{url('show')}}" class="gg">الوكلاء العقاريين</a></li>
                            <li><a href="{{url('getMyEstate')}}" class="gg">طلب عقاري</a></li>


                            <li><a href="{{route('about')}}" class="gg">من نحن</a></li>
                            <li class="active"><a href="{{route('home')}}" class="gg">الرئيسية</a></li>
