...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js" charset="UTF-8"></script>
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll"  style="    background: linear-gradient(rgb(191 211 232 / 31%), rgb(209 219 231 / 29%)), url(images/property_6.jpg);width: 100%;height: 80vh;margin-top: 100px;background-size: cover;background-position: center center;"  data-speed="0.8"></div>
						...
						<div class="contact_info_content">
							<ul class="contact_info_list">
								...
								<li>
									...
									<div style="margin-left: -30px;"><h5 style="color: #203e60;   "> <i class="fa-solid fa-phone ii"style="margin-right: 15px;color: #203e60;" ></i>0966333221</h5></div>
								</li>
								<li>
