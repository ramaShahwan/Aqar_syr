                ...
                <div class="col-md-12">
                    ...
                    @csrf
                        ...
                        <div class="form-group mb-3 d-flex align-items-center">
                            ...
                            <div class="d-flex w-100" style="flex-direction: column;" >
                                <input id="phone" placeholder="ادخل رقم هاتفك " type="text" class="form-control " name="phone" value="" required autocomplete="phone"  style="background-color: var(--bs-secondary-bg);text-align: end;">
                        ...
                        <div class="row mb-0 mt-3 justify-content-center">
                            <div class="col-md-6 offset-md-10">
                                <button type="submit" class="btn btn-block text-light btnre" style=" background-color: #507cc7;
        width: 100px;
         height: 40px;
          margin-top: 30px;">
                                    {{ __('إنشاء') }}
