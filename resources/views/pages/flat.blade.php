...
<div class="home">
    ...
    <div class="search_form_content d-flex flex-row align-items-start justify-content-start flex-wrap">
        <div>
            <select class="search_form_select pp" id="type" name="type" required>
                ...
                <option style="direction: rtl;" value="استراحة">استراحة (مزرعة- شاليه)</option>
                <option style="direction: rtl;" value="غرفة">غرفة</option>
                <option style="direction: rtl;" value="صالة">صالة</option>
            </select>
        </div>
        <div>
            <select class="search_form_select pp" id="purpose" name="purpose" required>
    ...
    <button type="submit" class="search_form_button ml-auto">بحث</button>
</form>
